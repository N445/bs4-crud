...
<?php
if (isset($field_type_use_statements)) {
foreach ($field_type_use_statements as $className): ?>
use <?= $className ?>;
<?php
endforeach;
}
...
<?php
if (isset($constraint_use_statements)) {
foreach ($constraint_use_statements as $className): ?>
use <?= $className ?>;
<?php
endforeach;
}
...
<?php else: ?>
            ->add('<?= $form_field ?>',
                <?= $typeOptions['type'] ? ($typeOptions['type'] . '::class') : 'null' ?>,
                [
